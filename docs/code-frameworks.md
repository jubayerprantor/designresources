...
> CSS frameworks, HTML templates, JavaScript animation libraries, UI component kits for React, Vue, Angular, Svelte, and design system references.

---

**Jump to:** [HTML & CSS Templates](#html-css-templates) · [CSS Frameworks](#css-frameworks) · [CSS Methodologies](#css-methodologies) · [CSS Animations](#css-animations) · [JS Animation Libraries](#js-animation-libraries) · [JS Chart Libraries](#js-chart-libraries) · [UI Components & Kits](#ui-components-kits) · [React UI Libraries](#react-ui-libraries) · [Vue UI Libraries](#vue-ui-libraries) · [Angular UI Libraries](#angular-ui-libraries) · [Svelte UI Libraries](#svelte-ui-libraries) · [React Native UI Libraries](#react-native-ui-libraries) · [Design Systems & Style Guides](#design-systems-style-guides)
...
| Resource | Description |
| :--- | :--- |
| [brandsinmotion.xyz](https://www.brandsinmotion.xyz/directory) | This is a list organized into Claude, Gemini, and General categories. |
| [github.com](https://github.com/0xWelt/Awesome-Vibe-Coding) | This is a list organized into Claude, Gemini, and General categories. |
| [github.com](https://github.com/microsoft/ai-agents-for-beginners) | This is a list organized into Claude, Gemini, and General categories. |
| [github.com](https://github.com/Shubhamsaboo/awesome-llm-apps) | This is a list organized into Claude, Gemini, and General categories. |
| [hoyokin.tistory.com](https://hoyokin.tistory.com/78) | This is a list organized into Claude, Gemini, and General categories. |
